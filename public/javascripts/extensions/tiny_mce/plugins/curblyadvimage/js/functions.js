...
function upload_image_callback(url, alt_text, photo_id){
  ...
  new Ajax.Request("/admin/manage_photos?photo_id="+photo_id, {asynchronous:true, evalScripts:true, method:'get'});
}
...
function ts_onload(){
	$('dynamic_images_list').update("Uploading...<br /><img src='/images/admin/spinner.gif'>");
